...
export const enUS: TranslationDict = {
  ...
  settings: {
    ...
    aiModels: {
      title: "AI Models",
      description: "Add and manage your AI models. The selected one is used by the AI assistant.",
      activeBadge: "Active",
      useBtn: "Use",
      deleteBtn: "Delete",
      ...
      empty: {
        title: "No models yet",
        desc: "Add an OpenAI-compatible or Anthropic model to start using the AI assistant.",
        cta: "Add Model",
      },
      add: {
        title: "New Model",
        subtitle: "Fill in the connection details. You can switch between models anytime.",
        confirm: "Save",
        cancel: "Cancel",
      },
      fields: {
        name: "Model Name",
        namePlaceholder: "e.g. GPT-4o, Claude Sonnet, Self-hosted…",
      ...
      errors: {
        ...
        nameDuplicate: "A model named \"{name}\" already exists",
